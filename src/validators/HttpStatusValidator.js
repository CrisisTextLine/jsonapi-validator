 ...
 * @param {Object} response - The response body (optional)
 * @returns {Object} Validation result with success/failure and details
 */
export function validateHttpStatus(statusCode, method, response = null) {
  const results = {
    valid: true,
    errors: [],
    warnings: [],
 ...
 */
function validateSuccessStatus(statusCode, method, response, results) {
 ...
 * @param {Object} results - Results object to update
 */
function validateClientErrorStatus(statusCode, method, response, results) {
  const hasErrors = response && Object.prototype.hasOwnProperty.call(response, 'errors')
  const hasData = response && Object.prototype.hasOwnProperty.call(response, 'data')
 ...
 * @param {Object} results - Results object to update
 */
function validateServerErrorStatus(statusCode, method, response, results) {
  const hasErrors = response && Object.prototype.hasOwnProperty.call(response, 'errors')
