 ...
 * @param {string} url - The relative URL string to validate
 * @returns {boolean} True if relative URL is valid format
 */
 ...
 * @returns {string} Error message describing why URL is invalid
 */
